...
<body style="position: relative; width: 100%; height: 100%;">
    <div style="position: relative; top: 0; bottom: 0; left: 0; right: 0; background-color: #000000">
        <img style="margin-top: 100px" src="images/BPC_Logo_Black.jpg" alt="background">
    </div>
    <div style="position: relative; margin-top: 20px; font-family: 'Economica', sans-serif; font-size: 25px; color: #ffffff; font-weight: 600;">
        We've moved. Check out <a style="text-decoration: none; color: #ffffff" href="http://www.brodiepark.com">BrodiePark.com</a>.
    </div>
</body>
</html>